...
In this article, we illustrate how \vmps, a dedicated simulation framework to
perform in-depth investigations of VM placement algorithms and compare
them in a fair way can help researchers to move forward in VM
placement proposals.. To cope with real conditions such as the
