...
\AL[MS]{The values for the vanilla implementation do not correspond to
Table 1. Moreover it is strange that the value with 32LCs per GM is as
close as the DVMS ones after the reactive change ? We should clarify
that point}
