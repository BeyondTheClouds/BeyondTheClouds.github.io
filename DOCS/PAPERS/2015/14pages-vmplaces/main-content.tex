...
experimental methodology. Regarding the virtual machines, ten VMs have
...
infrastructure almost did not face VM violations with our selected
...
128, 256, 512, 1024 and 2048 PMs, \AL[JP]{Add 2048 if succeeded} for each PM
number hosting 10 times as many VMs. Additional simulated PMs have
...
\MS[AL]{The following paragraph is wrong with respect to the fault
  experiments of Snooze: much higher fault rate and still only
  moderate impact. I can replace it with an accurate 4--5 line par.}
...
in the article and only gives major trends.  \AL[MS]{Please update
  consequently the sentence above and the paragraph below} Regarding
...
migration. Hence, it is usually better to try to find the right
...
\AL[JP]{Please add scalability test (i.e. in terms of durations) here}
...
\centering
    {\scriptsize \begin{tabular}{|P{20mm}@{\:}||@{\:}c@{\:}|@{\:}c@{\:}||@{\:}c@{\:}|@{\:}c@{\:}|}
      ...
      \thickhline
       ...
       1024 nodes & 11.41 $\pm$   3.36 & \:11.45 $\pm$ 3.39 &   702 & \:616 
...
\AL[JP]{Please instead of putting cumulated violation time, could you
  please add mean and std to cope with Snooze information (see Figure
  6). Please keep also the number of migrations that is important and
  it would be great to add such an information to the Snooze results
  if possible}
...
\AL[MS]{Please add a preamble for this section}
...
%     \thickhline
%       Reactive      & 107 & 201 & 421 & 10.24 $\pm$   4.48 & 10.02 $\pm$   3.32 & 10.62 $\pm$   7.21 \\
%       Periodic 30s  & 62 & 124 & 269 & 20.92 $\pm$  13.02 & 23.33 $\pm$  14.47 & \:23.57 $\pm$  20.19
%     \Rstrut  \\ \hline
%     \thickhline
% \end{tabular} }
...
We have also harnessed VMPlaceS in order to analyze the fault
