...
Consequently, lot of placement algorithms are continuously proposed
without really identifying the significant benefits of each of them.

In this article, we illustrate how \vmps, a dedicated simulation
...
researchers to mesure and validate the advantages of new propoosals.
...
\cite{6838300,shen:ccgrid2015}, allowing \textit{in vivo} experiments
to be restricted to VMPP mechanisms that have the potential to handle CC
