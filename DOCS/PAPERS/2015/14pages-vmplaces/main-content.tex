...
\caption{Details of violations duration occuring during simulation
  (1024 PMs).}
...
100K PMs and 1 Millions VMs over a period of one day.
 ...
 As future work,
it would be valuable to add additional dimensions in order to simulate
...
Finally, we plan to provide a dedicated API to be able to provision
