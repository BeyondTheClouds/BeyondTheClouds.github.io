...
researchers to mesure and validate real benefits of new proposals.

To cope with real conditions such as the
increasing scale of modern data centers and the dynamicity of the
workloads that are specific to the CC paradigm \cite{6838300,shen:ccgrid2015}, \vmps allows users to study large-scale scenarios that take
...
simulation lifetime. Built on top of the \sg toolkit~\cite{casanova:hal-01017319}, \vmps
