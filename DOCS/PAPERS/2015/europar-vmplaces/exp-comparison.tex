...
\AL{Ici dire qu'il y a pleins d'autres metriques pertinentes comme le
  nombre de migrations qui a été faite, ..... mais que faute de place
  nous ne pouvons pas les discuter ici. Neanmoins cette etude nous a
  permis de voir pleins de trucs sympa et des améliorations possibles.
Le reactif vs le periodique. puis passer aux related works}
