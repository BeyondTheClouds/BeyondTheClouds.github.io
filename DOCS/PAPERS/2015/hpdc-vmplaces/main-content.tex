...
migration lasts less than 20 seconds in average , we believe that that
...
\caption{Entropy 2.0 - Comparison between simulated}
\flushleft\footnotesize{The red parts correspond to the time periods where Entropy checks the viability
