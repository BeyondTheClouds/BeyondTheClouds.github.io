...
Table~\ref{table:detailed_violation_time} gives the mean and the
standard deviations of the duration of each violation.
As expected, the centralized approach does not scale well and becomes
...
\begin{center}
  ...
  \end{tabular} }
    ...
    \caption{Means $\pm$ standard deviations of violation durations.}
\end{center}
\end{table}
...
\begin{center}
  ...
  \end{tabular} }
    ...
    \caption{Means $\pm$ standard deviations of computation duration.}
\label{tab:detailed_computation_time}
\end{center}
\end{table}
...
\begin{center}
  ...
  \end{tabular} }
    ...
    \caption{Means $\pm$ standard deviations of Reconfiguration Durations.}
\end{center}
\label{tab:detailed_violation_time}
\end{table}


Even if the implementations of these three
algorithms are all based on Entropy, their respective amount of nodes invocking
