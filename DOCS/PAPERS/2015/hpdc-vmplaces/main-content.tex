...
Figure \ref{fig:detailed_computation_time} depicts the
...
scheduling policy: according figure \ref{fig:experiments_violation_time}, the time
spend with VMs that are experiencing a QoS violation is dramatically higher than
...
noted that in a carefuly observation Figure \ref{fig:detailed_violation_time}
...
\ref{violation_clouds_1024} shows how significant is the dispersion of the
violation duration when using the hierarchical algorithm.

\begin{figure}[ht]
\begin{center}
    \includegraphics[width=.95\linewidth]{figures/experiments/1024-distributed-hierarchical.pdf}
    \caption{Details of violations duration occuring during simulation (10240 VMS).}
\end{center}
\label{fig:violation_clouds_1024}
\end{figure}
