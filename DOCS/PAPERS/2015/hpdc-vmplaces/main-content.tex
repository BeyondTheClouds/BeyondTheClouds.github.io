...
anticipated, the centralized approach did not scale and became even
counterproductive for the largest scenario in comparison to a system
where there were no dynamic scheduling. The more nodes Entropy has to
...
has to solve more violations simultaneously, the reconfiguration plan
...
\AL[JP]{replay the simulations without any
...
\begin{tabular}{|P{27mm}@{\:}||@{\:}c@{\:}|@{\:}c@{\:}|@{\:}c@{\:}||@{\:}c@{\:}|@{\:}c@{\:}|@{\:}c@{\:}|}
      ...
      \thickhline
\end{tabular} }
\label{table:snooze-gmpart-8}
\caption{Influence of the group size in Snooze ($Med\pm \sigma$)}
\end{table}
...
\begin{tabular}{|P{27mm}@{\:}||@{\:}c@{\:}|@{\:}c@{\:}|@{\:}c@{\:}||@{\:}c@{\:}|@{\:}c@{\:}|@{\:}c@{\:}|}
      ...
      \thickhline
\end{tabular} }
\label{table:snooze-gmpart-4}
\caption{Influence of the group size in Snooze ($Med\pm \sigma$)}
\end{table}

Tables \ref{table:snooze-gmpart-8} and \ref{table:snooze-gmpart-4}
show the simulated values obtained
for scenarios with respectively 8~LCs and 4~LCs per GM for each infrastructure size.
...
the 8-LCs per GM scenario. We noticed, however, that reducing the
...
problem. This is a rather important limitations
tried to reduce to number to 4
...
\subcapcentertrue
\subfigure[DVMS]{
  \includegraphics[width=.45\linewidth]{figures/experiments/clouds-1024-distributed.pdf}
  \label{fig:violation_clouds_dvms_1024}}
\subfigure[Snooze]{
  \includegraphics[width=.45\linewidth]{figures/experiments/clouds-1024-hierarchical-periodic-30.pdf}
  \label{fig:violation_clouds_snooze_1024}}
\caption{Details of violations duration occuring during simulation (10240 VMS).}
