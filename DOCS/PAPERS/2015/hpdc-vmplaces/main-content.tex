...
more important (around 7 days). The consuming portions of code are
related to \sg internals such as sleep and communication calls and we
are currently investigating with the \sg core developers how we can
reduce the required time to perform such advanced simulations.
