...
Figure~\ref{fig:renater} allows to better capture the advantages of our proposal. It
...
appropriate infrastructures, \ie that are reliable and efficient enough to operate UC
...
network center with a number of servers dedicated to VM hosting. Because it is
