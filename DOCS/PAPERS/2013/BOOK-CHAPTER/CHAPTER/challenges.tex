...
\item \textbf{Sustainability:} Although the LUC approach natively reduces the energy
  footprint of UC services by minimizing the network impact, \ftodo[FQ$\rightarrow$AL]{Ce
    n'est pas l'avis du reviewer de Middleware. Et nous n'avons à ma connaissance pas de
    données pour affirmer une telle chose} it is important to go one step further by
