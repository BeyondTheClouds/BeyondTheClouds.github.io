...
to that node.
\AL[MS]{and manages: who manages GM or LC ?please clarify}
...
\AL[MS, AL]{I propose to merge a bit more so we can remove
  subsubsections for Snooze}
...
While \texttt{XHOST} and \texttt{XVM} and the
