...
Virtual Machine Placement Problem (VMPP) have been developed by the
...
algorithms that have been deeply investigated by our community
...
processes that have been used to evaluate them: most VMPP proposals have
...
executed at all, are always expensive and tedious to perform as has
