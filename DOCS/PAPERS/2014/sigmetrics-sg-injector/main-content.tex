...
\MS[AL]{The fig. is not perfect, among others because it contains
  features, \eg the communication arrows, that are not obvious nor
  explained.}
...
strategies. \MS{Could we be more assertive: this/that study has shown
  that the use of Java is worthwhile \ldots?}
% TODO: not adressed
