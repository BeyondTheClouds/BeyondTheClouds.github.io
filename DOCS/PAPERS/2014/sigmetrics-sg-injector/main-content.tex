...
%%%%%%%
\AL[MS]{This formulation is still not valid. Moreover, most... we
  already explained that above ?}
Moreover, most available IaaS toolkits, notably many of the most
popular ones~\cite{cloudstack, opennebula, openstack}, continue to
...
\cite {feller:ccgrid12}, \cite{Hermenier:2009:ECM:1508293.1508300},
\cite{5715067}, \cite{quesnel:cpe2012}, \cite{5328077},
 \cite{5935254}.  \MS{Be more assertive on the motivation: Adrien,
