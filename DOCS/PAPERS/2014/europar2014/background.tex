...
%%\AL[CT/MB]{nodes known by nodes c'est un peu rude ca non ;) ?}
...
\AL[CT/MB]{Pourquoi ca cause de Notre overlay ici. on est bien dans la section Background, les paragraphes suivants devraient etre dans 3.1 non ? Ici il faut simplement introduire Vivaldi non ? Peut etre simplement reformuler en : Another approach adopts a lazy strategy consisting ...\cite{vivaldi}. Vivaldi places nodes in ... }
