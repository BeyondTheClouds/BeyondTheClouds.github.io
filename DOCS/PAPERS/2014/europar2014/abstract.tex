...
to peer approaches  have been proposed for scheduling virtual machine (VM).
...
%
% %%%
As network bandwidth/latency/interconnection fluctuate over time, using a static partitioning of the
resources is not enough. 
