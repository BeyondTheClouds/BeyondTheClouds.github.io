...
efficiency of both overlay networks.

Firstly, using the LBO decreases the
...
partition duration 46\% lower than that encountered with Chord. This result is consistent with 
...
performing scheduling/reconfiguring phases much faster, since migration operations are
