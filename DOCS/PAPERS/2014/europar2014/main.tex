...
\newcommand{\FQ}[2]{\todo[color=blue!20,inline,size=\small]{\IfNoValueTF{#2}{\textbf{AL}}{\textbf{AL$\Rightarrow$#1}} #2}}
\newcommand{\JP}[2]{\todo[color=red!50,inline,size=\small]{\IfNoValueTF{#2}{\textbf{AL}}{\textbf{AL$\Rightarrow$#1}} #2}}
\newcommand{\CT}[2]{\todo[color=brown!50,inline,size=\small]{\IfNoValueTF{#2}{\textbf{AL}}{\textbf{AL$\Rightarrow$#1}} #2}}
\newcommand{\MB}[2]{\todo[color=yellow!50,inline,size=\small]{\IfNoValueTF{#2}{\textbf{AL}}{\textbf{AL$\Rightarrow$#1}} #2}}
\newcommand{\FD}[2]{\todo[color=orange!50,inline,size=\small]{\IfNoValueTF{#2}{\textbf{AL}}{\textbf{AL$\Rightarrow$#1}} #2}}
