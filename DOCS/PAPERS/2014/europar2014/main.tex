...
\newcommand{\CT}[2][]{\customtodo{JP}{yellow!20}{#1}{#2}}
\newcommand{\MB}[2][]{\customtodo{JP}{orange!20}{#1}{#2}}
%
...
%
\author{Jonathan Pastor\inst{1}, Marin Bertier\inst{2}, Adrien Lebre\inst{1}, 
Flavien Quesnel\inst{1} \and Cedric Tedeschi\inst{3}}
%
\authorrunning{J. Pastor, M. Bertier, A. Lebre, F. Quesnel \and C. Tedeschi}
