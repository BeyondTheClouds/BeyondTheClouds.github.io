...
\MB[AL]{Áa risque de prendre pas mal de place. Mais pourquoi pas. figure +
  explication de la figure... Notre idÈe est de mettre plusieurs figures ... Au
  moins 3 pour illustrer un scenario d'amÈlioration d'une spirale sortant d'un
  noeud donne. On essaye de faire Áa ce soir. On prÈcise que si ensuite tu
...
%   * ainsi on a cr√©√© une librarie qui:
%		- favorise le dvlpt d'appli distribu√©e.
...
%   * Peer actor:
%		- apporte la tolerance aux pannes, abstraction du r√©seau, communication
%		  interservices.
%		- propose une API pour d√©velopper vite.
...
%		- network overlay actor: r√©seau avec impl√©mentation chord et vivaldi.
