...
\AL[MS]{Could you please clarify the figure: where does the LC run ?
  I thought that there is one LC on each host ? Here we get the
  feeling that LCs run on distinct nodes ?}
\begin{figure}
