...
efficiency.
\AL[MS]{maybe we can remove the part ``because it is ..'' and simply
  make the transition with ``Moreover ..''}
%
...
% :~Minimizing the cost of reconfiguration between a non viable
% configuration (i.e., a mapping between VMs and PMs) and a viable one
