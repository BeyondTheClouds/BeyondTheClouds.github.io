...
At coarse-grained, to perform simulations, users should develop  a \emph{program} and define a
\emph{platform} file. The \emph{program} in most cases leverages the \sg MSG API
that allow end-users to create and execute processes, tasks, VMs and
