...
More flexible and often more efficient approaches to the Virtual Machine
...
\cite{quesnel:cpe2012}, \cite{5935254}, \cite{5715067}.  Hence we
may ask why most available  IaaS toolkits, ....


\MS{Rather
 underline the ``more efficient strategies'' instead of
  ``surprise'' because new approaches may not be mature enough?}  It
...
\cite{5328077}.  \MS{Be more assertive on the motivation: previous
  articles for justification?}  From our point of view, an important
