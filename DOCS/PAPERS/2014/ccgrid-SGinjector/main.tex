...
%
We chose to build our framewok on the \sg
...
\AL{We should explain the deployment file in the \sg section}
...
new queue will be merged to the global one and consume during the
\emph{Injector Phase}.
...
consumes the different events. That is for the moment, either by changing the load of a VM or
...
\AL[JP]{Could you please complete this paragraph to deal with the JSON
  extensions.}
...
simulation by leveraging an extended version of the TRACE
