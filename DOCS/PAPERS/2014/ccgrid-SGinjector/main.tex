...
leveraging the corresponding MSG API of \sg. \AL[JP]{Here we should
  add something like: This offer the opportunity to researchers to
  develop new algorithms by using high level programming abstractions
...
\AL{Not really convinced by this last sentence... if someone has a better
  proposal, please feel free.}
