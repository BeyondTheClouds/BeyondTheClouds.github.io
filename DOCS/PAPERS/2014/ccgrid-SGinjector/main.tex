...
execution.
%%%%%%%
\AL[MS]{Ca va pas la transition, il manque un keeping using greedy ...
parce que sinon le faire de dire que les static approaches sont
utilisés dans les IaaS c'est deja dit au dessus :(}
...
pas ceux attendus. Ca me parait correcte !?} (\ie real-world)
experiments implies,
